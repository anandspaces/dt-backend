...
export const books = pgTable(
  "books",
  {
    ...
    /** JSON: subject, class_num, board, curriculumMap, etc. */
...
export const atomAudio = pgTable(
  "atom_audio",
  {
    id: id(),
    atomId: text("atom_id")
...
export const files = pgTable(
  "files",
  {
    ...
    /** book = textbook PDF; pyq = previous-year questions PDF */
...
export const pdfExtractionLogs = pgTable(
  "pdf_extraction_logs",
  {
    id: id(),
    fileId: text("file_id")
...
export const atomClassifications = pgTable(
...
export const atomScores = pgTable(
  "atom_scores",
  {
    id: id(),
    atomId: text("atom_id")
...
export const learningStyleScores = pgTable(
...
export const calibrationTests = pgTable(
  "calibration_tests",
  {
    id: id(),
    userId: text("user_id")
...
export const calibrationResponses = pgTable(
...
export const preparednessScores = pgTable(
  "preparedness_scores",
  {
    id: id(),
    userId: text("user_id")
